...
!(function() {
  function r(e) {
    ...
    const n = [];
    const i = document;
    const o = i.documentElement.doScroll;
    const r = 'DOMContentLoaded';
    let a = (o ? /^loaded|^c/ : /^loaded|^i|^c/).test(i.readyState);
    a ||
      i.addEventListener(
        r,
        (t = function() {
  ...
  const c = function(e, t) {
    !(function(e, t) {
      ...
      if (
        ...
        const d = (r.body || r.getElementsByTagName('head')[0]).childNodes;
        n = d[d.length - 1];
      }
      const c = r.styleSheets;
      (a.rel = 'stylesheet'),
        (a.href = e),
        (a.media = 'only x'),
        (function e(t) {
  ...
  const e = function(e, t, n) {
    const i = t && void 0 !== t.autoFetchSvg ? t.autoFetchSvg : void 0;
    const o = t && void 0 !== t.async ? t.async : void 0;
    const r = t && void 0 !== t.autoA11y ? t.autoA11y : void 0;
    const a = document.createElement('script');
    const d = document.scripts[0];
    (a.src = e),
  ...
  function s(e, t) {
    const n = (t && t.addOn) || '';
    const i = (t && t.baseFilename) || e.license + n;
    const o = t && t.minify ? '.min' : '';
    const r = (t && t.fileSuffix) || e.method;
    const a = (t && t.subdir) || e.method;
    return `${e.baseUrl}/releases/${
      e.version === 'latest' ? 'latest' : 'v'.concat(e.version)
    }/${a}/${i}${o}.${r}`;
  }
  let t;
  let n;
